package com.rocketmq_quickstart.rocketmqstudy.consumer;
...
/**
 * @Author zhangyue
 * @CreatedTime 2020/5/15 15:46
 **/
@Slf4j
@Component
public class Consumer4QuickStart {
    /**
     * 消费者实体对象
     */
     ...
     * 通过构造函数 实例化对象
     */
    public Consumer4QuickStart() throws MQClientException {
